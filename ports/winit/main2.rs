...
pub extern "C" fn alloc_printer() {
    eprintln!("Alloc count: {}", unsafe { elytron_lib::alloc_count });
    eprintln!("Alloc_zeroed count: {}", unsafe { elytron_lib::alloc_zeroed_count });
    eprintln!("Dealloc count: {}", unsafe { elytron_lib::dealloc_count });
    eprintln!("Realloc count: {}", unsafe { elytron_lib::realloc_count });
}
